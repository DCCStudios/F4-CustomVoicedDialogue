...
public sealed class SynthesisService
{
    ...
    public string NpcVoiceFingerprint()
    {
        ...
        var accentPart = accents.Length == 0 ? "" : $"|ipa17:{accents}|{_config.AccentImperfection}";
        return Fingerprint(
