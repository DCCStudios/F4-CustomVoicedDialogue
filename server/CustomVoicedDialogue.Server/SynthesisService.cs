...
public sealed class SynthesisService
{
    ...
    public string PlayerVoiceFingerprint()
    {
        ...
        // "ipa:" marks the lexicon-based pronunciation mechanism — bumping it
        // invalidated audio generated by the older respelling approach.
        var accentPart = accent.IsNeutral ? "" : $"|ipa:{accent.Id}|{_config.AccentImperfection}";
        return Fingerprint(
    ...
    public string NpcVoiceFingerprint()
    {
        ...
        var accentPart = accents.Length == 0 ? "" : $"|ipa:{accents}|{_config.AccentImperfection}";
        return Fingerprint(
